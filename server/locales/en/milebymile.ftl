...
milebymile-reason-exceeds-distance = you are at { $current } miles, and a { $distance }-mile card would put you at { $total } miles, past the { $target }-mile finish; exact finish is on, so you need exactly { $miles } more miles
