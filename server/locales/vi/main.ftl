...
# Xác thực
auth-username-password-required = Tên người dùng và mật khẩu là bắt buộc.
auth-registration-success = Đăng ký thành công! Bây giờ bạn có thể đăng nhập bằng thông tin đăng nhập của mình.
auth-username-taken = Tên người dùng đã được sử dụng. Vui lòng chọn tên người dùng khác.
...
mute-global-chat-option = Tắt chat toàn cục: { $status }
mute-table-chat-option = Tắt chat trong bàn: { $status }
...
# Broadcast
broadcast-announcement = Thông báo toàn server
admin-broadcast-prompt = Nhập nội dung thông báo gửi đến toàn bộ người dùng online. (Tin nhắn này sẽ được gửi tới tất cả mọi người!)
...
milebymile-rig-2x-attacks = Nhân 2 Tấn công
milebymile-rig-2x-defenses = Nhân 2 Phòng thủ
admin-broadcast-sent = Đã gửi thông báo đến { $count } người dùng.
