...
milebymile-unplayable-card-menu-title = Không thể đánh lá bài này
milebymile-unplayable-discard-question = Bạn không thể đánh { $card } vì { $reason }. Bạn có muốn bỏ lá này không?
milebymile-no-card-selected = Chưa chọn lá bài nào để bỏ.
milebymile-no-valid-targets = Không có mục tiêu hợp lệ cho sự cố này!
milebymile-you-drew = Bạn đã rút: { $card }
milebymile-you-discard = Bạn bỏ lá { $card }.
milebymile-discards = { $player } bỏ lá bài { $card }.
milebymile-select-target = Chọn một mục tiêu

milebymile-you-play-distance-individual = Bạn đánh lá { $distance } dặm, hiện đang ở dặm thứ { $total }.
milebymile-plays-distance-individual = { $player } đánh lá { $distance } dặm, hiện đang ở dặm thứ { $total }.
milebymile-you-play-distance-team = Bạn đánh lá { $distance } dặm; đội của bạn hiện đang ở dặm thứ { $total }.
milebymile-plays-distance-team = { $player } đánh lá { $distance } dặm; đội của họ hiện đang ở dặm thứ { $total }.

milebymile-you-complete-perfect-individual = Bạn đã hoàn thành hành trình với màn về đích chuẩn xác tuyệt đối!
milebymile-journey-complete-perfect-individual = { $player } đã hoàn thành hành trình với màn về đích chuẩn xác tuyệt đối!
milebymile-your-team-completes-perfect = Đội của bạn đã hoàn thành hành trình với màn về đích chuẩn xác tuyệt đối!
milebymile-journey-complete-perfect-team = Đội { $team } đã hoàn thành hành trình với màn về đích chuẩn xác tuyệt đối!
milebymile-you-complete-individual = Bạn đã hoàn thành hành trình!
milebymile-journey-complete-individual = { $player } đã hoàn thành hành trình!
milebymile-your-team-completes = Đội của bạn đã hoàn thành hành trình!
milebymile-journey-complete-team = Đội { $team } đã hoàn thành hành trình!

milebymile-you-play-hazard-individual = Bạn đánh lá { $card } lên { $target }.
milebymile-hazard-played-on-you = { $player } đánh lá { $card } lên bạn.
milebymile-plays-hazard-individual = { $player } đánh lá { $card } lên { $target }.
milebymile-you-play-hazard-team = Bạn đánh lá { $card } lên Đội { $team }.
milebymile-hazard-played-on-your-team = { $player } đánh lá { $card } lên đội của bạn.
milebymile-plays-hazard-team = { $player } đánh lá { $card } lên Đội { $team }.

milebymile-you-play-card = Bạn đánh lá { $card }.
milebymile-plays-card = { $player } đánh lá { $card }.
milebymile-you-play-dirty-trick = Bạn đánh lá { $card } như một Đòn Phản Công!
...
milebymile-from-safeties = { $points } từ { $count } { $count ->
    [one] lá bảo hộ
    *[other] lá bảo hộ
}
milebymile-from-all-safeties = { $points } từ đủ bộ 4 lá bảo hộ
milebymile-from-dirty-tricks = { $points } từ { $count } { $count ->
    [one] đòn phản công
    *[other] đòn phản công
}

milebymile-you-win-individual = Bạn thắng trò chơi!
milebymile-wins-individual = { $player } thắng trò chơi!
milebymile-your-team-wins = Đội của bạn thắng trò chơi!
...
milebymile-reason-stopped = bạn cần Đèn Xanh trước khi có thể chạy
milebymile-reason-has-problem = xe của bạn đang bị một sự cố chặn lại
milebymile-reason-out-of-gas = bạn không thể chạy vì đã hết xăng; hãy đánh Xăng hoặc Thùng Xăng Phụ trước
milebymile-reason-flat-tire = bạn không thể chạy vì bị xịt lốp; hãy đánh Lốp Dự Phòng hoặc Lốp Chống Đinh trước
milebymile-reason-accident = bạn không thể chạy vì đã gặp tai nạn; hãy đánh Sửa Chữa hoặc Tay Lái Lụa trước
milebymile-reason-speed-limit = bạn đang bị Giới Hạn Tốc Độ, nên chỉ được đánh lá 25 hoặc 50 dặm
milebymile-reason-exceeds-distance = bạn đang ở { $current } dặm, và lá { $distance } dặm sẽ đưa bạn lên { $total } dặm, vượt quá đích { $target } dặm; vì đang bật yêu cầu về đích chính xác, bạn cần đúng { $miles } dặm nữa
milebymile-reason-too-many-200s = bạn đã đánh hai lá 200 dặm trong chặng đua này rồi
milebymile-reason-no-targets = hiện không có đối thủ nào có thể nhận sự cố này hợp lệ
milebymile-reason-no-opponents = không có đội đối thủ nào để nhắm tới
milebymile-reason-hazard-protected = mọi mục tiêu có thể đều được { $safety } bảo vệ khỏi { $card }
milebymile-reason-hazard-karma = bạn đã mất Nghiệp và chỉ có thể tấn công mục tiêu cũng đã mất Nghiệp
milebymile-reason-hazard-duplicate-speed-limit = mọi mục tiêu có thể đều đã bị Giới Hạn Tốc Độ
milebymile-reason-hazard-duplicate = mọi mục tiêu có thể đều đã có { $card }
milebymile-reason-hazard-blocked = mọi mục tiêu có thể đều đã bị một sự cố khác chặn lại
milebymile-reason-no-speed-limit = bạn không bị giới hạn tốc độ
milebymile-reason-has-right-of-way = Xe Ưu Tiên cho phép bạn đi mà không cần đèn xanh
milebymile-reason-already-moving = xe của bạn đang chạy rồi
milebymile-reason-must-fix-first = bạn phải xử lý { $problem } trước bằng { $remedy }
...
milebymile-dirty-trick = Đánh Đòn Phản Công
