...
tossup-desc-starting-dice = Chọn số viên khi bắt đầu mỗi lượt và khi nhận bộ mới sau lúc mọi viên đều ra mặt xanh. Luật gốc dùng 10 viên.

tossup-desc-target-score = Trò chơi bước vào các lượt cuối sau khi có người chốt điểm vượt mốc này. Luật gốc dùng mốc 100.
