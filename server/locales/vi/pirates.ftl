...
pirates-steal-success-them = { $attacker } đã trộm viên { $gem } của bạn!
...
pirates-level-up-multiple = { $player } đã tăng { $levels } cấp! Hiện là cấp { $level }!
pirates-level-up-multiple-you = Bạn đã tăng { $levels } cấp! Hiện là cấp { $level }!
...
pirates-ocean-kai = Dòng Hải Lưu Kai
...
pirates-gem-7 = ngọc nhựa to tướng
pirates-gem-8 = ngọc xanh tuyệt đỉnh
pirates-gem-9 = thạch anh tím
pirates-gem-10 = nhẫn vàng
pirates-gem-11 = ngọc tủy đỏ tuyệt đỉnh
pirates-gem-12 = huyết thạch đỏ tuyệt đỉnh
...
pirates-skill-captain-desc = Tăng +2 công và +2 thủ trong 4 lượt.
...
pirates-skill-not-turn = Chưa đến lượt bạn.
...
pirates-menu-cooldown = { $name } (đang hồi: { $turns } lượt)
